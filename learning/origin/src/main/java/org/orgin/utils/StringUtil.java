...
import org.orgin.constant.RepositoryConstant;
...
public final class StringUtil {
    ...
    public static String generateBracketPlaceHolder(Integer size) {
        String joinPlaceHolder = Stream.generate(() -> RepositoryConstant.PLACEHOLDER).limit(size).collect(Collectors.joining(RepositoryConstant.DELIMITER));
        return RepositoryConstant.LEFT_BRACKET + joinPlaceHolder + RepositoryConstant.RIGHT_BRACKET;
    }
}

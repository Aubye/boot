package com.app.platform.common.data.jpa;

import com.app.platform.common.data.sign.*;
import com.app.platform.common.function.Nullable;
import com.app.platform.common.utils.ClassUtil;
...
public final class SpecificationBuilder {
    ...
    public static Specification buildSpecification(@NotNull Object condition) {
    ...
    public static <T> Specification<T> buildSpecification(@NotNull Object condition, ParameterizedTypeReference<T> typeReference) {
        Class<?> conditionClass = condition.getClass();
        List<Field> declaredFields = ClassUtil.getClassInfo(conditionClass).getFields();
        return (root, query, cb) -> {
            List<Predicate> predicates = new ArrayList<>(declaredFields.size());
